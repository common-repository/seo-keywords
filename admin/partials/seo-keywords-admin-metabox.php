<?php
    ...
    $seo_links_keywords_related = $seo_links_keywords_related ?? array();
    $seo_links_keywords_impressions = $seo_links_keywords_impressions ?? array();
    $seo_links_keywords_clicks = $seo_links_keywords_clicks ?? array();
    $seo_links_keywords_position = $seo_links_keywords_position ?? array();
    $seo_links_last_update = $seo_links_last_update ?? '';
    $sc_api_key = $sc_api_key ?? '';
    $seo_keywords_credits = $credits->seo_keywords ?? 0;
?>
<style>
    .seo_keywords_tab_title{
        margin: 0;
        font-size: 1rem;
        padding-bottom: 8px;
        cursor: pointer;
    }
    .seo_keywords_tab_title.active{
        font-weight: 600;
    }
</style>
<!-- SEO Keywords -->
<div class="tabs-panel">
    ...
    <script>
        function showRanked(){
            jQuery('.seo_keywords_tab_title.related').removeClass('active');
            jQuery('.seo_keywords_tab_title.ranked').addClass('active');
            jQuery('#seo_keywords').show();
            jQuery('#seo_keywords_related').hide();
        }
        function showRelated(){
            jQuery('.seo_keywords_tab_title.related').addClass('active');
            jQuery('.seo_keywords_tab_title.ranked').removeClass('active');
            jQuery('#seo_keywords').hide();
            jQuery('#seo_keywords_related').show();
        }
    </script>
    <div style="display: flex;align-items: center;justify-content: space-between;">
        <div class="seo_keywords_tab_title ranked active" onclick="showRanked();">Ranked KW</div>
        <div class="seo_keywords_tab_title related" onclick="showRelated();">Related KW</div>
    </div>
    <div id="seo_keywords" style="max-height: 250px;overflow: scroll;">
        <?php if( $seo_links_keywords_position ) : ?>
            ...
            <table style="margin: 8px 0;">
                <tr>
                    <th scope="row" style="cursor: pointer;width: 55%;">Keyword</th>
                ...
                <?php foreach( $seo_keywords as $seo_link => $seo_position ) : ?>
                    <tr class="seo_keywords">
                        ...
                        <td style="text-align: center;">
                            <?php echo esc_html( $seo_links_keywords_clicks[ $seo_link ] ); ?>
                        </td>
                        <td style="text-align: center;">
    ...
    <div id="seo_keywords_related" style="max-height: 250px;overflow: scroll;display:none;">
        <?php if( $seo_links_keywords_related ) : ?>
            ...
            <table style="margin: 8px 0;">
                ...
                <?php
                $seo_keywords = array();
                foreach( $seo_links_keywords_related as $seo_link ) :
                    $seo_keywords[ $seo_link ] = $seo_links_keywords_impressions[$seo_link];
                endforeach;
                arsort( $seo_keywords );
                ?>
